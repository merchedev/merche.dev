...
module.exports.connect = () => new Promise((resolve, reject) => {
	...
	MongoClient.connect(process.env.DB_HOST, option, function(err, result) {
...
module.exports.collection = (collection_name) => db.db(process.env.DB_NAME).collection(collection_name);
